---
name: public-content-extractor
description: Extract generalized, public-safe engineering lessons from explicit source material for consulting-content use. Use when the user asks to mine, review, or extract public content ideas from W2 work, consulting work, private notes, experiments, open source work, homelab work, or delivery summaries; always route source-derived candidates through confidentiality review before drafting.
---
...
7. Apply $confidentiality-guardian before drafting or publication.
...
Capture the reusable engineering lesson while making the source organization and source engagement impossible to identify.
